  ...
  emergencyContactsSettings: {
    ...
    automatedEmergencySettings: {
      ...
      sleepSchedule: {
        ...
        updatedToast: 'Sleep schedule updated',
      },
      sleepScheduleSheet: {
        title: 'Set up your sleep schedule',
        description:
  ...
  specificTimesScreen: {
    title: 'Pause Emergency System',
      pauseNow: {
        ...
        customDurationHint: 'Adjust hours and minutes',
        hours: 'Hours',
        minutes: 'Minutes',
        ...
        pauseForDuration: 'Pause for {{duration}}',
        systemPaused: 'System is paused',
        pausedUntil: 'Paused until {{time}}',
        cancelPause: 'Cancel pause',
        pauseEnabled: 'Paused',
        pauseDisabled: 'Pause monitoring',
        enablePauseHint: 'Turn on to pick a pause duration.',
