...
const translations: ITranslation = {
  ...
  signUp: {
    ...
    steps: {
      eyebrow: 'PASSO {{current}} DI {{total}}',
    },
    common: {
      next: 'Avanti',
    },
  ...
  authScreen: {
    ...
    signIn: {
      title: 'Bentornato.',
      subtitle: 'Accedi al tuo account tomorrow.bio.',
      cta: 'Accedi',
  ...
  userName: {
    ...
    subtitle:
      "Appare nelle notifiche d'emergenza inviate ai suoi contatti.",
    firstName: 'Nome',
    lastName: 'Cognome',
    firstNamePlaceholder: 'es. Pietro',
    lastNamePlaceholder: 'es. Rossi',
  },
  userPhone: {
    title: 'Qual è il suo numero di telefono?',
    combinedTitle: 'Telefono e nascita',
    combinedSubtitle:
      "Usato per la sicurezza dell'account e la verifica dell'età.",
  ...
  userAddress: {
    title: 'Il suo indirizzo',
    subtitle:
      'Usato quando i soccorsi devono localizzarla rapidamente.',
    street: 'Via',
    city: 'Città',
    country: 'Paese',
    zipCode: 'CAP',
    currentLocation: 'Usa la mia posizione attuale',
    wrongAddress:
  ...
  emergencyContactsSettings: {
    ...
    emergencyMessageEditHelper:
      "Modifica il messaggio che i tuoi contatti riceveranno durante un'emergenza.",
    emergencyMessageHelper:
      "Questo messaggio verrà inviato via SMS ed e-mail ai tuoi contatti di emergenza quando viene attivato il flusso di emergenza.",
    ...
    documents: {
      title: 'Documenti',
      topInfo:
        'Carica i documenti importanti di cui i tuoi contatti di emergenza potrebbero avere bisogno. Formati accettati: PDF, DOC, DOCX, JPG o PNG.',
      tapToUpload: 'Tocca per caricare',
      formatsAction: 'PDF, DOC, DOCX, JPG o PNG · Tocca per caricare',
      uploadedFile: 'Caricato · {{fileName}}',
    ...
    automatedEmergencySettings: {
      ...
      howItWorks: {
        ...
        step2Title: 'Monitora',
        step2Desc:
          'L\'app controlla regolarmente i tuoi dati sulla salute. Se non viene rilevato alcun segnale, riceverai prima una notifica di avviso.',
        step3Title: 'Emergenza',
        step3Desc:
      ...
      timeTrigger: {
        ...
        description:
          'Invieremo notifiche ogni tot di tempo. Se non rispondi a una di esse, verrà attivato il sistema di emergenza. I tuoi orari di sonno vengono esclusi automaticamente.',
        frequency: 'Tempo di attivazione di emergenza:',
      ...
      sleepSchedule: {
        ...
        description:
          'Mette automaticamente in pausa il sistema di emergenza durante le tue ore di sonno abituali per evitare falsi allarmi.',
        enableSchedule: 'Attiva programma del sonno',
        bedtime: 'Ora di andare a letto',
        wakeTime: 'Ora del risveglio',
        sleepWindow:
          'Il sistema si mette in pausa ogni notte dalle {{bedtime}} alle {{wakeTime}}',
        updatedToast: 'Programma del sonno aggiornato',
      },
      sleepScheduleSheet: {
        title: 'Configura il tuo programma del sonno',
        description:
          'Il sistema di emergenza deve sapere quando dormi per non attivare falsi allarmi durante la notte.',
        hint: 'Tocca un orario per modificarlo',
        save: 'Attiva programma del sonno',
        skip: 'Salta per ora',
      },
      pauseTime: {
  ...
  specificTimesScreen: {
    title: 'Sistema di emergenza in pausa',
      pauseNow: {
        title: 'Metti in pausa il monitoraggio',
        description:
          'Metti temporaneamente in pausa la protezione per una breve durata scelta da te.',
        ...
        quickOneHour: '1 ora',
        quickOneDay: '1 giorno',
        customDuration: 'Durata personalizzata',
        customDurationHint: 'Regola ore e minuti',
        hours: 'Ore',
        minutes: 'Minuti',
        durationDays: '{{count}} giorno',
        durationDays_plural: '{{count}} giorni',
        durationHours: '{{count}} ora',
        durationHours_plural: '{{count}} ore',
        durationMinutes: '{{count}} minuto',
        durationMinutes_plural: '{{count}} minuti',
        pauseForDuration: 'Pausa per {{duration}}',
        systemPaused: 'Sistema in pausa',
        pausedUntil: 'In pausa fino a {{time}}',
        cancelPause: 'Annulla pausa',
        pauseEnabled: 'In pausa',
        pauseDisabled: 'Metti in pausa',
        enablePauseHint:
          'Attiva per scegliere una durata di pausa.',
      disablePauseHint:
        'Disattiva per riprendere subito il monitoraggio.',
      inactiveState:
        'Il monitoraggio è attivo. Attiva l’interruttore quando hai bisogno di una breve pausa.',
    },
    addTimeBlock: {
  ...
  bioCheck: {
    messages: {
      ...
      wearableSyncWarning: 'Nessun dato sanitario recente ricevuto',
      wearableSyncWarningBody:
        'Apri l\'app del tuo wearable per sincronizzare i dati sanitari. Se il problema persiste, seguirà un controllo di emergenza.',
