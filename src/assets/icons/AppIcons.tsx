...
export const AppleIcon = React.memo(
  ({size = 24, color = semanticColors.primary, ...props}: AppIconProps) => (
    <Svg width={size} height={size} viewBox="0 0 24 24" fill="none" {...props}>
      <Path
        d="M16.37 1.43c.02 1.35-.5 2.55-1.33 3.5-.9 1.03-2.35 1.82-3.58 1.72-.16-1.29.48-2.62 1.25-3.46.86-.95 2.4-1.69 3.66-1.76Zm3.69 16.53c-.54 1.24-.8 1.8-1.5 2.9-.98 1.5-2.35 3.37-4.05 3.39-1.51.01-1.9-.98-3.95-.97-2.05.01-2.48.98-3.99.97-1.7-.02-3-1.7-3.97-3.21-2.72-4.21-3.01-9.15-1.33-11.78 1.2-1.87 3.08-2.96 4.86-2.96 1.81 0 2.95.99 4.45.99 1.45 0 2.34-1 4.43-1 1.58 0 3.25.86 4.44 2.35-3.9 2.14-3.27 7.72.61 9.33Z"
        fill={color}
      />
    </Svg>
  ),
...
export const BrainIcon = makeIcon(
  <>
    <Path d="M9.5 2A2.5 2.5 0 0 0 7 4.5v.1A3 3 0 0 0 4.5 9c-.8.55-1.5 1.5-1.5 2.7 0 1.5 1 2.7 2.3 3.1A3.2 3.2 0 0 0 8.5 20H10V4.5A2.5 2.5 0 0 0 7.5 2" />
    <Path d="M14.5 2A2.5 2.5 0 0 1 17 4.5v.1A3 3 0 0 1 19.5 9c.8.55 1.5 1.5 1.5 2.7 0 1.5-1 2.7-2.3 3.1A3.2 3.2 0 0 1 15.5 20H14V4.5A2.5 2.5 0 0 1 16.5 2" />
    <Path d="M10 8H7.5A2.5 2.5 0 0 0 5 10.5" />
    <Path d="M14 8h2.5A2.5 2.5 0 0 1 19 10.5" />
    <Path d="M10 14H7.5A2.5 2.5 0 0 1 5 11.5" />
    <Path d="M14 14h2.5A2.5 2.5 0 0 0 19 11.5" />
  </>,
);
